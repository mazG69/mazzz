...
if (six.PY2):
    ...
    import urllib.parse
acil = LINETCR.LINE()
acil.login(token="EsHLEujxZ7Vk4lV5i4t2.uyKr/g/CsJwFxTiyF9EiqG.qsARxRUwYJEja/OUU9ABuAJSWN01YYf7lWn2DqOONVo=")
acil.loginResult()
#ki = PRANKBOTS.LINE()
...
Bots=[mid,]
admsa = "u518911f86f9c4a359f5ed2187fd78842" #MID SELFBOT
PRANKBOT = ["u518911f86f9c4a359f5ed2187fd78842"] #MID OWNER
wait = {
    'contact':False,
    'autoJoin':True,
	    ...
	    if "Xvideos " in msg.text:
            ...
            if "Help" == msg.text:
              if msg.from_ in PRANKBOT:
                if wait["lang"] == "JP":
                	...
                	msg.contentType = 13
                	acil.sendText(msg.to,"Big Bos")
                	msg.contentMetadata = {'mid':'u518911f86f9c4a359f5ed2187fd78842'}
                	acil.sendMessage(msg)
                else:
                	acil.sendText(msg.to,helpMessage1)
                	msg.contentType = 13
            ...
            if "Respon" == msg.text:
              if msg.from_ in PRANKBOT:
                ...
                #ki5.sendMessage(msg)
                acil.sendText(msg.to,"AMAN TERKENDALI KOMANDAN 👮")
            if "Set" == msg.text:
              if msg.from_ in PRANKBOT:
                md = "╔▬▬℘ґ∂ηк в❍тs▬▬╗\n║▬▬▬℘▬▬в▬▬▬║\n"
                ...
                acil.sendText(msg.to,md + "║ฬђợ ค๓ เ ╝")
...
#=====================================================================================   
                ...
                if msg.toType == 1:
                    ...
                    turl = acil.getUserTicket(tid)
                    acil.sendText(msg.to,"line://ti/p" + turl)
                else:
                    acil.sendText(msg.to,"error")
...
#                    acil.sendText(msg.to,"Tidak dapat digunakan untuk kelompok selain")
               ...
               # if msg.from_ in admin or owner:
                ...
                acil.sendText(msg.to,"already turn active")
            elif msg.text in ["Simisimi off","Simisimi:off"]:
                settings["simiSimi"][msg.to] = False
                acil.sendText(msg.to,"BOT API SIMISIMI TURN OFF")
                acil.sendText(msg.to,"already non active")
	...
	#      if msg.toType == 2:
                ...
                if wait["kickMention"] == True:
                    if wait["lang"] == "JP":
                        acil.sendText(msg.to,"☠️DANGER TAG KICK ON☠️")
                else:
                ...
                if wait["kickMention"] == False:
                   if wait["lang"] == "JP":
                        acil.sendText(msg.to,"SELF PROTECT TAG OFF ✔")
                else:
                    wait["kickMention"] = False
                    if wait["lang"] == "JP":
                        acil.sendText(msg.to,"already turn OF")
...
#-----------------------------------------------
 ...
 #---------Fungsi Banlist With Tag--------#
                ...
                if wait["blacklist"] == {}:
                    ...
                    acil.sendText(msg.to,"Blacklisted user")
                ...
                if msg.toType == 2:
                   ...
                   acil.sendText(msg.to,"blacklist done all removed 👮")
                ...
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        acil.sendText(msg.to,"Daftar hitam pengguna tidak memiliki")
                        return
...
#-----------------------------------------------
                ...
                ginfo = acil.getGroup(msg.to)
                acil.sendText(msg.to,"ᶳᵉˡᵃᵐᵃᵗ ᴰᵃᵗᵃᶰᵍ ᴰᶤ ᶠᵃᵐᶤˡʸ " + str(ginfo.name))
                acil.sendText(msg.to,"ᴷᵘᶰᶜᵉᶰ ᴳʳᵒᵘᵖ " + str(ginfo.name) + " :\n" + ginfo.creator.displayName )
            elif "Bc " in msg.text:
